		...
		<footer className="relative overflow-hidden border-t border-white/[0.08] bg-[#070909] px-4 py-16 text-foreground sm:px-6">
			...
			<div className="relative mx-auto max-w-7xl min-w-0">
				<div className="mb-12 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
					...
					<div className="min-w-0 overflow-hidden rounded-[2rem] border border-primary/20 bg-primary/[0.075] p-6 md:p-8">
									...
									<li key={link.to}>
										<Link to={link.to} className={linkClass}>
											...
											{'badge' in link && link.badge ? (
												<span className="ml-2 rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.18em] text-primary">
													{link.badge}
												</span>
											) : null}
										</Link>
