...
function Features() {
    return (
        <section className="relative overflow-hidden bg-background px-4 py-24 transition-colors ambient-glow sm:px-6 md:py-36">
            ...
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(169,198,82,0.13),transparent_28rem),radial-gradient(circle_at_80%_35%,rgba(98,98,198,0.08),transparent_24rem)]" />
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-5">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                        viewport={{ once: true }}
                        className="group relative overflow-hidden rounded-[2rem] border border-border/80 bg-[linear-gradient(135deg,rgba(169,198,82,0.13),rgba(255,255,255,0.78)_48%,rgba(236,253,245,0.9))] p-6 shadow-xl shadow-primary-dark/10 dark:bg-[linear-gradient(135deg,rgba(169,198,82,0.12),rgba(255,255,255,0.035)_45%,rgba(15,23,42,0.45))] dark:shadow-2xl dark:shadow-primary-dark/20 lg:col-span-7 lg:p-8"
                    >
                        <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full border border-primary/20 bg-primary/10 blur-2xl transition-transform duration-500 group-hover:scale-110" />
                        <div className="relative z-10 flex h-full flex-col justify-between gap-8">
                            <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                                <div>
                                    <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-bold uppercase tracking-widest text-primary">
                                ...
                                <div className="shrink-0 rounded-3xl border border-white/[0.08] bg-background/70 p-5 text-center shadow-inner">
                                    <p className="text-5xl font-black tracking-[-0.08em] text-primary sm:text-6xl">95%</p>
                    ...
                    >
                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_15%,rgba(169,198,82,0.12),transparent_16rem)]" />
                        <div className="relative z-10">
                            <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10">
                                <Network className="h-6 w-6 text-primary" />
                            </div>
                            <p className="mb-2 text-xs font-bold uppercase tracking-[0.22em] text-primary">{features[1].eyebrow}</p>
                    ...
                    {features.slice(2).map((feature, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group relative overflow-hidden rounded-3xl border border-white/[0.08] bg-card/70 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card lg:col-span-3"
                        >
                            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
                            <div className="mb-5 flex items-center justify-between gap-4">
                                <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-primary/15 bg-primary/10 transition-colors group-hover:bg-primary/15">
                            ...
                            <p className="mt-auto border-t border-white/[0.06] pt-4 text-xs font-semibold text-primary/90">{feature.proof}</p>
                        </motion.div>
                    ))}
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="rounded-3xl border border-primary/15 bg-primary/[0.06] p-6 lg:col-span-12"
                    >
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-[0.24em] text-primary">Deployment</p>
