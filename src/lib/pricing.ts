...
export const PRICING_PLANS: PricingPlan[] = [
	{
		...
		monthlyPriceLabel: '£20',
		annualPriceLabel: '£192',
		monthlyPriceValue: 20,
		annualPriceValue: 192,
		annualSavingsLabel: 'Save £48/year',
...
export const INTERNAL_HOSTED_PLAN_IDS: Record<HostedPlanId, { monthlyEnv: string; annualEnv: string; hardcodedMonthly?: string; hardcodedAnnual?: string }> = {
	starter: {
		...
		hardcodedAnnual: 'f647c1c8-2b80-406d-8a0f-f2be29087b51',
	},
	growth: {
